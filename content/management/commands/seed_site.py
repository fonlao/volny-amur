...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        routes = [
            ("Шантарские острова", "Экспедиция", "8 дней", "Средний", "от 168 000 ₽", "июль — сентябрь", "Киты в Охотском море, лежбища тюленей и дикие бухты архипелага. Добираемся катером и живём в тёплом глэмпинге.", "ocean"),
            ("Дуссе-Алинь", "Треккинг", "10 дней", "Сложный", "от 124 000 ₽", "июнь — август", "Горные озёра, водопады и каменные цирки заповедного хребта. Настоящая автономная экспедиция с опытным проводником.", "mountain"),
            ("По следам тигра", "Экотур", "5 дней", "Лёгкий", "от 76 000 ₽", "февраль — март", "Зимняя тайга Сихотэ-Алиня, следы амурского тигра и ночёвки на кордоне. Наблюдаем природу бережно и с безопасной дистанции.", "forest"),
            ("Амурские протоки", "Сплав", "4 дня", "Лёгкий", "от 49 000 ₽", "май — октябрь", "Неторопливое путешествие на каяках среди островов великой реки, рыбацких сёл и дальневосточных закатов.", "river"),
        ]
        for order, row in enumerate(routes, 1):
            title, tag, days, level, price, season, text, visual_style = row
            Route.objects.get_or_create(title=title, defaults={"tag": tag, "days": days, "level": level, "price": price, "season": season, "text": text, "visual_style": visual_style, "order": order})
        guides = [
